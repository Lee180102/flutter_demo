...
class SlideButton extends StatefulWidget {
  ...
  SlideButton({this.key, @required this.child, @required this.singleButtonWidth, @required this.buttons, this.onSlideStarted, this.onSlideCompleted, this.onSlideCanceled}) : super(key: key);
