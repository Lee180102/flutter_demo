...
import 'package:flutter_demo/demo/remove_item/remove_item.dart';

class RemoveItemRoute extends StatefulWidget {
  RemoveItemRoute({Key key}) : super(key: key);

  @override
  _RemoveItemRouteState createState() => _RemoveItemRouteState();
}

class _RemoveItemRouteState extends State<RemoveItemRoute> {
      ...
      body: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return RemoveItem(
              listBank[index],
              index,
              new RemoveWidget(listBank[index]),
...
class RemoveWidget extends StatelessWidget {
  ...
  const RemoveWidget(this.result, {Key key}) : super(key: key);
